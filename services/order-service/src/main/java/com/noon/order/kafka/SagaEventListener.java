...
import com.noon.order.events.EventEnvelope;
import com.noon.order.service.OrderService;
...
public class SagaEventListener {
    ...
    @KafkaListener(topics = "${noon.topics.inventory-events}", groupId = "order-service")
    ...
    @KafkaListener(topics = "${noon.topics.payment-events}", groupId = "order-service")
