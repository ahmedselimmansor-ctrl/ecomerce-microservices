...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Query("""
            ...
            where o.status in (com.topchoice.order.domain.OrderStatus.CONFIRMED,
                               com.topchoice.order.domain.OrderStatus.PROCESSING,
                               com.topchoice.order.domain.OrderStatus.SHIPPED,
                               com.topchoice.order.domain.OrderStatus.DELIVERED)
            """)
    ...
    @Query("""
            ...
            where o.createdAt >= :since
              and o.status in (com.topchoice.order.domain.OrderStatus.CONFIRMED,
                               com.topchoice.order.domain.OrderStatus.PROCESSING,
                               com.topchoice.order.domain.OrderStatus.SHIPPED,
                               com.topchoice.order.domain.OrderStatus.DELIVERED)
            """)
