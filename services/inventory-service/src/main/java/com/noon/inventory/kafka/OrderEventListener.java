package com.noon.inventory.kafka;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.noon.inventory.events.EventEnvelope;
import com.noon.inventory.service.InventoryService;
import com.noon.inventory.service.InventoryService.RequestedLine;
...
public class OrderEventListener {
    ...
    @KafkaListener(topics = "${noon.topics.order-events}", groupId = "inventory-service")
