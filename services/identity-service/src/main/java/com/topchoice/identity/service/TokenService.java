 ...
 *
 * <p>محليًا نستخدم HS256 بمفتاح مشترك. في الإنتاج على Google Cloud يُستبدل بـ RS256/ES256
 * مع مفتاح خاص في Cloud KMS ونشر JWKS على {@code /.well-known/jwks.json}، فتتحقق باقي
