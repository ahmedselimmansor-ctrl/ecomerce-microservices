package com.noon.identity.web;

import com.noon.identity.error.ApiException;
import com.noon.identity.service.TokenService;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public static final String ATTR_USER_ID = "noon.userId";
    public static final String ATTR_ROLES = "noon.roles";
