 ...
 */
@Component
@ConditionalOnProperty(name = "noon.gateway.provider", havingValue = "mock", matchIfMissing = true)
public class MockPaymentGateway implements PaymentGateway {
    ...
    public MockPaymentGateway(@Value("${noon.gateway.mock-failure-rate:0.1}") double failureRate,
                              @Value("${noon.gateway.mock-latency-ms:250}") long latencyMs) {
