...
> في الإنتاج يُنشأ عبر Identity Platform أو سكربت إداري بكلمة مرور من Secret Manager
...
2. **رفع الصور** — نقبل روابط؛ الإنتاج يحتاج رفعًا إلى Cloud Storage (برابط موقّع مباشرةً من المتصفح) مع معالجة تشغّلها Eventarc على Cloud Run.
