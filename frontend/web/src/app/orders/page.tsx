...
export default function OrdersPage() {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        ...
        <button
          ...
          className="mt-4 rounded-lg bg-tc-accent px-6 py-2.5 text-sm font-bold"
        >
          إعادة المحاولة
        </button>
      </div>
  ...
  if (!orders || orders.length === 0) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        <Package className="mx-auto size-16 text-tc-line" aria-hidden />
          ...
          return (
            <li key={order.id}>
              <Link
                ...
                className="card-tc flex items-center justify-between gap-4 p-4 transition hover:shadow-md"
              >
