# TopChoice — Cloud-Native E-Commerce Platform on AWS

منصة تجارة إلكترونية عربية مبنية كـ **microservices** ومصمّمة من الأساس للتشغيل
على **AWS / EKS** — عشر خدمات مستقلة، واجهة Next.js بالعربية من اليمين لليسار،
ولوحة تحكم كاملة لإدارة المنتجات والطلبات والمخزون.
...
**نظام الألوان — «Petrol & Saffron».** مشتقّ من عالم السوق نفسه لا من لوحة عامة:
أزرق البترول من قيشاني الخزف الإسلامي، الزعفران من سوق العطارة، والرمّاني من
ثمرة الرمّان.
...
**بطاقة المنتج:** شارة `Best Seller`، قلب المفضّلة، زر إضافة سريعة، تقييم أخضر،
سعر مشطوب ونسبة خصم، سطر إشارة واحد بترتيب أولوية (كمية محدودة ← الأكثر مبيعًا ←
توصيل مجاني)، وشارة التوصيل السريع المائلة.
