...
| `frontend` | القسمة على 100 تحدث عند العرض فقط، وكاش المُنسِّقات لا يخلط بين نسخة بعملة وأخرى بدونها. واختيار إشارة البطاقة: واحدة فقط بترتيب أولوية ثابت، والإلحاح أقلية وإلا فقد اللون معناه |
