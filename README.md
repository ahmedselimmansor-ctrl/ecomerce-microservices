...
| **الاختبارات** | 256 اختبار وحدة · 4 اختبارات تزاحم على PostgreSQL حقيقي · 40 حالة على المتجر · 28 على لوحة التحكم |
...
`make integration` يشغّل أربعة اختبارات على PostgreSQL حقيقي:
...
> تحقّقنا أن الاختبار ليس أخضر فارغًا: بإزالة `@Lock(PESSIMISTIC_WRITE)` من
> المستودع يفشل فورًا، وبإعادته يمرّ.
